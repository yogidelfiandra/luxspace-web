...
function Loading() {
  return Array(6)
    ...
    .map((_, index) => {
      return (
        <div key={index} className='px-4 relative card group animate-pulse'>
          <div
            className='rounded-xl bg-slate-200 overflow-hidden card-shadow relative'
...
export default function JustArrived() {
  ...
  return (
    <section className='flex flex-col py-18 xl:py-24'>
      ...
      <div className='overflow-x-hidden px-4' id='carousel'>
        ...
        {isLoading ? (
          <div
            className='flex -mx-4 flex-row relative cursor-pointer'
            style={{
              paddingLeft:
